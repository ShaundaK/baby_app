...
# user = User.new(first_name: "Will", last_name: "Orvell", username: "WillO", password: "", email: "WOrvell@Orvell.com", phone_number: "773-999-9998", summary: "My wife and I are giving away a brand new crib. We received two at our baby shower. Please contact if intersted.", age_of_child: "0 months - 2 years", gender_of_child: "unisex", zipcode: "60609")
  ...
  category = Category.new(name: "Car Seats")
    category.save
  category = Category.new(name: "Strollers")
    category.save
  category = Category.new(name: "Furniture")
    category.save
  category = Category.new(name: "Clothing")
    category.save
  category = Category.new(name: "Bedding & Decor")
    category.save
  category = Category.new(name: "Nursing & Feeding")
    category.save
  category = Category.new(name: "Bath & Potty")
    category.save
  category = Category.new(name: "Health")
    category.save
  category = Category.new(name: "Toys & Learning")
    category.save
